                    ...
                    <div class="p-6 space-y-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <input id="target_quantity" name="target_quantity" type="number" step="0.01" min="0" value="{{ old('target_quantity', $indicator->target_quantity) }}" class="mt-1 block w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm" />
