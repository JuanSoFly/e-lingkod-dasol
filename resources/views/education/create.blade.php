<x-app-layout>
    <x-slot name="header">
        <div class="flex justify-between items-center">
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">
                {{ __('Add Education Record') }} - {{ $employee->full_name }}
            </h2>
    ...
    <div class="py-12">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            ...
            <form method="POST" action="{{ route('employees.education.store', $employee) }}" enctype="multipart/form-data">
                @csrf
                    ...
                    <div class="p-6 bg-white border-b border-gray-200">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div id="degree_field" class="hidden">
                                ...
                                <input type="text" name="degree_course" id="degree_course" value="{{ old('degree_course') }}" 
                    ...
                    <div class="p-6 bg-white border-b border-gray-200">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                            ...
                            <div>
                                ...
                                <input type="number" name="period_from" id="period_from" value="{{ old('period_from') }}" 
                            ...
                            <div>
                                ...
                                <input type="number" name="period_to" id="period_to" value="{{ old('period_to') }}" 
                                       min="1900" max="{{ date('Y') + 10 }}"
                            ...
                            <div>
                                ...
                                <input type="number" name="year_graduated_pds" id="year_graduated_pds" value="{{ old('year_graduated_pds') }}" 
                                       min="1900" max="{{ date('Y') + 10 }}"
                                       placeholder="e.g. 2022"
                                       class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500">
                            ...
                            <div class="md:col-span-3">
                                ...
                                <input type="text" name="highest_level_units_earned" id="highest_level_units_earned" value="{{ old('highest_level_units_earned') }}" 
                    ...
                    <div class="p-6 bg-white border-b border-gray-200">
                        ...
                        <div>
                            ...
                            <textarea name="scholarship_honors_received" id="scholarship_honors_received" rows="4"
                                      ...
                                      class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500">{{ old('scholarship_honors_received') }}</textarea>
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg mb-6">
                    <div class="p-6 bg-white border-b border-gray-200">
                        ...
                        <div>
                            <label for="attachment" class="block text-sm font-medium text-gray-700">Education Document</label>
                            <input type="file" name="attachment" id="attachment" 
                                   accept=".pdf,.jpg,.jpeg,.png"
                                   class="mt-1 block w-full text-sm text-gray-500 file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-semibold file:bg-blue-50 file:text-blue-700 hover:file:bg-blue-100">
                            <p class="text-xs text-gray-500 mt-1">
                                Upload diploma, transcript, certificate, or other education credential (PDF, JPG, PNG - Max 5MB)
                            </p>
                        </div>
                    </div>
                </div>
