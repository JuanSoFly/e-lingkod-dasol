        ...
        <div class="bg-white overflow-hidden shadow-sm rounded-lg border border-gray-200">
            <div class="px-6 py-4 border-b border-gray-200 flex justify-between items-center">
                <div>
                     ...
                     <p class="text-sm text-gray-500 mt-1">Create a new announcement to be displayed to employees.</p>
                </div>
                ...
                <form action="{{ route('admin.announcements.store') }}" method="POST" class="space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="flex items-center md:pt-8">
                             <label for="is_important" class="inline-flex items-center">
                                <input id="is_important" type="checkbox" class="rounded border-gray-300 text-indigo-600 shadow-sm focus:ring-indigo-500" name="is_important" value="1" {{ old('is_important') ? 'checked' : '' }}>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <x-text-input id="starts_at" class="block mt-1 w-full" type="date" name="starts_at" :value="old('starts_at')" />
                        ...
                        <div>
                            ...
                            <x-text-input id="ends_at" class="block mt-1 w-full" type="date" name="ends_at" :value="old('ends_at')" />
