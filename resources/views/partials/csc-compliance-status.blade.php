...
function formatCSCFieldName($field) {
    $fieldNames = [
        ...
        'field_39_gov_id_number' => 'Government ID number (Field 39)',
        'field_39_gov_id_date_issued' => 'Government ID date issued (Field 39)',
        'field_39_gov_id_place_issued' => 'Government ID place issued (Field 39)',
