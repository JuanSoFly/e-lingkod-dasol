...
@section('title', 'Create Assignment - ' . $office->name)
...
<div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    ...
    <div class="mb-8">
        <div class="flex items-center justify-between">
            <div>
                ...
                <h1 class="text-3xl font-bold text-gray-900">Create Office Assignment</h1>
                <p class="mt-2 text-gray-600">Assign a new department head, assessor, or approver to {{ $office->name }}</p>
            </div>
    ...
    <div class="bg-white rounded-lg shadow-sm border border-gray-200">
        <form method="POST" action="{{ route('opcr.offices.assignments.store', $office) }}" class="p-6">
            @csrf
            ...
            <div class="mb-6">
                ...
                <select id="employee_id" name="employee_id" required
                    ...
                    <option value="{{ $employee->id }}" data-name="{{ $employee->full_name }}" data-employee-number="{{ $employee->employee_number }}">
            ...
            <!-- Preview Section -->
            <div id="assignmentPreview" class="mb-6 hidden">
                <div class="bg-yellow-50 border border-yellow-200 rounded-lg p-6">
                    <h3 class="text-lg font-semibold text-yellow-900 mb-4">Assignment Preview</h3>
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                        <div>
                            <span class="font-medium text-yellow-800">Employee:</span>
                            <span class="text-yellow-700 ml-2" id="previewEmployee">-</span>
                        </div>
                        <div>
                            <span class="font-medium text-yellow-800">Role:</span>
                            <span class="text-yellow-700 ml-2" id="previewRole">-</span>
                        </div>
                        <div>
                            <span class="font-medium text-yellow-800">Assignment Date:</span>
                            <span class="text-yellow-700 ml-2" id="previewStartDate">-</span>
                        </div>
                        <div>
                            <span class="font-medium text-yellow-800">End Date:</span>
                            <span class="text-yellow-700 ml-2" id="previewEndDate">Not specified</span>
                        </div>
                    </div>
                </div>
            </div>
    ...
    function updatePreview() {
        ...
        if (selectedEmployee && selectedEmployee.value && selectedRole && assignedDate) {
            ...
            if (isActive) {
                ...
                // Update text colors
                previewDiv.querySelectorAll('.text-yellow-800, .text-yellow-700').forEach(el => {
