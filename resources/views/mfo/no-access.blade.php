        ...
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-8 text-center">
                    ...
                    <p class="mt-2 text-sm text-gray-600">{{ $message ?? 'You do not have assignments for MFO configuration. Please contact the HRMO to request access.' }}</p>
                    <div class="mt-6">
