    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="bg-white shadow-sm rounded-lg border border-gray-200 mb-6">
            <div class="px-6 py-4 border-b border-gray-200">
                <div class="flex justify-between items-center">
                    <div>
                        <h2 class="text-2xl font-bold text-gray-900">My Document Requests</h2>
                        <p class="mt-1 text-sm text-gray-600">View and manage your document approval requests</p>
                    </div>
        ...
        <div class="bg-white shadow-sm rounded-lg border border-gray-200 mb-6">
            <div class="px-6 py-4">
                ...
                <form method="GET" action="{{ route('document-approvals.my-requests') }}" class="space-y-4">
        ...
        <div class="bg-white shadow-sm rounded-lg border border-gray-200">
            <div class="px-6 py-4 border-b border-gray-200">
                <h3 class="text-lg font-medium text-gray-900">My Requests</h3>
            </div>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                    <div class="flex space-x-2">
                                        ...
                                        @if($request->status === 'draft')
                                            <a href="{{ route('document-approvals.edit', $request) }}" 
                                               class="text-blue-600 hover:text-blue-900">
                                                Edit
                                            </a>
                                        @endif
                                        @if(in_array($request->status, ['submitted', 'under_review']))
                                            <form method="POST" action="{{ route('document-approvals.withdraw', $request) }}" 
                                                  class="inline-block" 
                            ...
                            <tr>
                                <td colspan="6" class="px-6 py-12 text-center text-sm text-gray-500">
                                    <div class="flex flex-col items-center justify-center">
                                        ...
                                        <p class="text-lg font-medium text-gray-900 mb-2">No document requests found</p>
                                        <p class="text-gray-500 mb-4">You haven't created any document approval requests yet.</p>
                                        <a href="{{ route('document-approvals.create') }}" 
                                           class="inline-flex items-center px-4 py-2 bg-indigo-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-indigo-700 focus:outline-none focus:border-indigo-900 focus:ring ring-indigo-300 transition ease-in-out duration-150">
                                            <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6v6m0 0v6m0-6h6m-6 0H6"/>
