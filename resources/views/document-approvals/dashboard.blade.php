        ...
        <div class="bg-white shadow-sm rounded-lg border border-gray-200 mb-6">
            <div class="px-6 py-4 border-b border-gray-200">
                <div class="flex justify-between items-center">
                    <div>
                        <h2 class="text-2xl font-bold text-gray-900">Approval Workflows Dashboard</h2>
                        <p class="mt-1 text-sm text-gray-600">Overview of approval workflow requests and analytics</p>
                    </div>
                        ...
                        <a href="{{ route('document-approvals.create') }}" 
                           class="flex items-center p-4 bg-indigo-50 rounded-lg hover:bg-indigo-100 transition-colors duration-200">
                            ...
                            <div class="ml-4">
                                ...
                                <p class="text-sm text-gray-500">Create a new approval workflow request</p>
                            </div>
                        </a>
